...
var readOnlyCommands = map[string]bool{
	...
	"bounty list":             true,
	"calendar list":           true,
	"calendar countdowns":     true,
	"calendar recent-invites": true,
	...
	"frames device":           true,
	"frames devices":          true,
	"frames household-config": true,
	"frames month-reviews":    true,
	"frames notifications":    true,
	"frames nudges":           true,
	"frames reminder-profile": true,
	"frames list":             true,
	"frames show":             true,
	"frame":                   true,
	"frame avatars":           true,
	...
	"frame device":            true,
	"frame devices":           true,
	"frame household-config":  true,
	"frame month-reviews":     true,
	"frame notifications":     true,
	"frame nudges":            true,
	"frame reminder-profile":  true,
	"frame list":              true,
	"frame show":              true,
	"grocery list":            true,
	"grocery show":            true,
	...
	"albums":                  true,
	"albums list":             true,
	"albums message-ids":      true,
	"albums messages":         true,
	"album":                   true,
	"album list":              true,
	"album message-ids":       true,
	"album messages":          true,
	"rewards list":            true,
	"rewards points":          true,
	"reward list":             true,
	...
	"routine list":            true,
	"sidekick":                true,
	"sidekick history":        true,
	"sidekick status":         true,
	"status":                  true,
	"version":                 true,
	"watch":                   true,
}
